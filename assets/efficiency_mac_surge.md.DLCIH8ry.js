import{b as m}from"./chunks/theme.DUz4Dgha.js";import{_ as S}from"./chunks/articleMetadata.BZDn_40x.js";import{_ as h,C as g,c as d,o as e,j as t,G as r,ah as C,a as R,w as i,b as c,e as u}from"./chunks/framework.DNA_OyuZ.js";const L="/assets/1720965600.DQOsskiT.png",E="/assets/1720965601.DDgJycPT.png",w="/assets/1720965602.DVvTdKKy.png",v="/assets/1720965603.DtHMf5yd.png",A="/assets/1720965604.DqVC9wZD.png",f="/assets/1720965605.D1FSLTlM.png",T="/assets/1720965606.Cv729y2P.png",_="/assets/1720965607.Cs4QKuOt.png",O=JSON.parse('{"title":"Surge配置","description":"对我而言，Surge就是MacOS上最好用的网络科学工具","frontmatter":{"sort":1,"title":"Surge配置","description":"对我而言，Surge就是MacOS上最好用的网络科学工具","date":"2025-02-14T22:01:42.000Z","tags":["MacOS"]},"headers":[],"relativePath":"efficiency/mac/surge.md","filePath":"posts/efficiency/mac/surge/README.md","lastUpdated":1743223023000}'),y={name:"efficiency/mac/surge.md"};function x(n,a,D,U,k,P){const o=S,p=g("ClientOnly"),b=m;return e(),d("div",null,[a[0]||(a[0]=t("h1",{id:"surge配置",tabindex:"-1"},[R("Surge配置 "),t("a",{class:"header-anchor",href:"#surge配置","aria-label":'Permalink to "Surge配置"'},"​")],-1)),r(p,null,{default:i(()=>{var s,l;return[(((s=n.$frontmatter)==null?void 0:s.aside)??!0)&&(((l=n.$frontmatter)==null?void 0:l.showArticleMetadata)??!0)?(e(),c(o,{key:0,article:n.$frontmatter},null,8,["article"])):u("",!0)]}),_:1}),r(p,null,{default:i(()=>{var s;return[(s=n.$frontmatter)!=null&&s.articleGPT?(e(),c(b,{key:0})):u("",!0)]}),_:1}),a[1]||(a[1]=C('<div class="tip custom-block"><p class="custom-block-title">前提</p><p>你需要确保你的Surge是激活状态</p></div><h2 id="订阅节点" tabindex="-1">订阅节点 <a class="header-anchor" href="#订阅节点" aria-label="Permalink to &quot;订阅节点&quot;">​</a></h2><p>使用开源项目：<a href="https://github.com/sub-store-org/Sub-Store" target="_blank" rel="noreferrer">Sub-Store</a><br> 介绍：适用于 Loon 、 Surge 和 Quantumult X 的高级订阅管理工具。完全本地解析，无订阅泄露的风险。</p><p><strong>安装：</strong></p><ol><li>打开Surge，找到 更多-模块</li><li>从URL安装模块，输入<code>https://raw.githubusercontent.com/sub-store-org/Sub-Store/master/config/Surge.sgmodule</code></li><li>订阅成功后，从模块中选择启用 <img src="'+L+'" alt="img" loading="lazy"></li><li>找到 解密-升成新证书-将证书安装到系统 <img src="'+E+'" alt="img" loading="lazy"></li><li>然后<strong>重启Surge</strong> 并在启动后 <strong>启用系统代理</strong></li><li>打开 <a href="https://sub.store" target="_blank" rel="noreferrer">https://sub.store</a>，如果网页正常打开并弹出以下提示，则说明Sub-Store已经配置成功，直接看<strong>第8步骤</strong><img src="'+w+'" alt="img" loading="lazy"></li><li>如果<strong>第6步骤</strong>发生如下报错或者打不开界面，请打开<a href="https://sub-store.vercel.app/subs" target="_blank" rel="noreferrer">https://sub-store.vercel.app/subs</a>，这说明<strong>系统代理未启用</strong>，启用之后就正常了 <img src="'+v+'" alt="img" loading="lazy"></li><li>接下来设置Sub-Store插件，进入配置界面点右下角➕号，选择单条订阅 <img src="'+A+'" alt="img" loading="lazy"></li><li>配置所有带*号的项目，简单说一个名称，一个你的订阅链接 <img src="'+f+'" alt="img" loading="lazy"></li><li>点击保存并返回，点击一下添加的订阅，然后复制Surge链接 <img src="'+T+'" alt="img" loading="lazy"></li></ol><h2 id="surge配置-1" tabindex="-1">Surge配置 <a class="header-anchor" href="#surge配置-1" aria-label="Permalink to &quot;Surge配置&quot;">​</a></h2><p>vscode新建文件，命名surge-custom.conf，将以下配置粘贴进去，然后全局替换<code>填上你Sub-Store的节点信息</code>为上面复制的链接，一般是<code>https://sub.store/download/xxx?target=Surge</code>，然后点开 <strong>更多-配置</strong>，导入配置文件，双击配置文件，在配置前打勾之后点击应用，这样就完成了</p><p><img src="'+_+`" alt="img" loading="lazy"></p><details class="details custom-block"><summary>配置详情，点击展开</summary><div class="language-txt vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[General]</span></span>
